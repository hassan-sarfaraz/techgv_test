...
jQuery(document).ready(function () {
    ...
    var newsTickerJSON = {
        "one": {
            "headline": "100% Authentic Products",
        ...
        "three": {
            "headline": "Temperature Controlled Delivery",
            "url": "javascript:void(0)",
            "icon": "fa-truck"
        }
    };
    ...
    function newsTickerHero() {
        ...
        tickerText.wrap("<a class='flex-ticker__a' href='" + newsTickerJSON[position].url + "' style='text-decoration: none;color: white'></a>");
