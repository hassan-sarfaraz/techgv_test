...
jQuery(document).ready(function () {
    ...
    var newsTickerJSON = {
        "one": {
            "headline": "منتجات أصلية 100٪",
            "url": "",
            "icon": "fa-comment"
        },
    
        "two": {
            "headline": "الدفع عند الاستلام",
            "url": "",
            "icon": "fa-credit-card"
        },
        "three": {
            "headline": "شحن مجاني للطلبات التي تزيد عن 100 درهم",
            "url": "",
            "icon": "fa-truck"
        },
        "three": {
    ...
    function newsTickerHero() {
        ...
        var tickerContainer = jQuery('.flex-ticker')
        var tickerText = jQuery(".flex-ticker__text");
    
        //fade in, pause, fade out then repeat
        tickerContainer.fadeIn('slow', function () {
            jQuery(this).delay(1500).fadeOut('slow', newsTickerHero);
        });
        ...
        tickerText.wrap("<a class='flex-ticker__a' href='" + newsTickerJSON[position].url + "' target='_blank' style='text-decoration: none;color: white'></a>");
        tickerText.prepend("<i class='fa " + newsTickerJSON[position].icon+ "'></i> ");
