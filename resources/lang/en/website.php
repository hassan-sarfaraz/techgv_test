...
return [
    ...
    */
	...
	'securepayment_desc' => 'Secure checkout verified by Norton VeriSign.',
	'authentic_product' => '100% Authentic Products',
	'authentic_product_desc' => 'We only deal with original products',
	'fast_delivery' => 'Fast Delivery Service',
	'fast_delivery_desc' => 'Fast delivery, competitive prices and excellent services',
	'Guest Checkout' => 'Guest Checkout',


	'HeaderOffer' => 'Get UPTO 40% OFF on your 1st order SHOP NOW',
	'Welcome' => 'Welcome',
	'Guest Checkout' => 'Guest Checkout',

	"Orders" => "Orders",
	"Login/Register" => "Login/Register",
	"Call Us Now" => "Customer Service",
	"My Cart" => "My Cart",
	"Home" => "الصفحة الرئيسية",
	"Shop" => "Shop",
	"30%OFF" => "Get UPTO 30% OFF on your 1st order SHOP NOW",
	"Welcome" => "Welcome",
	"TOP SELLING OF THE WEEK" => "TOP SELLING OF THE WEEK",
	"View All" => "View All",
	"NEWEST PRODUCTS" => "NEWEST PRODUCTS",
	"FOLLOW US" => "OrFOLLOW USders",
	"INFORMATION" => "INFORMATION",
	"OUR SERVICES" => "OUR SERVICES",
	"ABOUT STORE" => "ABOUT STORE",


	"dubai_address" => "Dubai Healthcare City, Ibn Sina Road Abu Dhabi , U.A.E",
	"Orders" => "Orders",
	...
	"Refund Plicy" => "Refund Plicy",
	"Term & services" => "Term & services",
	...
	"Gender" => "Gender",
	"refund_policy_statment." => "Creating an account means you accept  our Terms and Services,Privacy Policy  and  Refund Policy.",
	"social_network_statment" => "Access Your Account Through Your Social Networks",
	"Facebook" => "Facebook",
	"Google" => "Google",
	...
	"Flat Rate" => "Flat Rate",
	"Continue" => "Continue",
	"prefered_pay_method" => "Please select a prefered payment method to use on this order.",
	"notes_of_order" => "Please write notes of your order",
	"ORDER NOTES & SUMMARY" => "ORDER NOTES & SUMMARY",
	"Order Now" => "Order Now",
	"Braintree" => "Braintree",
	"Stripe" => "Stripe",
	...
	"Hyperpay" => "Hyperpay",
	"Congrates" => "Congrates",
	"success_product" => "Product Added Successfully Thanks.Continue Shopping",
	"OK" => "OK",
	"same_billing_address" => "Same shipping and billing address",
	...
	'bannerLabel1Text' => 'On order over AED 99',
	...
	'Copy Rights' => date('Y', time()) . ' Protien District. All rights reserved',
	...
	'Ecommerce' => 'Protein District &#8211; Choices&#8230; with more muscles.',
