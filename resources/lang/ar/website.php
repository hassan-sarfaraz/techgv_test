...
return [
    ...
    */
	// Infobox
	'securepayment'=> '100٪ مدفوعات آمنة',
	'securepayment_desc'=>'تم التحقق من الخروج الآمن بواسطة Norton VeriSign.',
	'authentic_product'=>'منتجات أصلية 100٪',
	'authentic_product_desc'=>'نحن نتعامل فقط مع المنتجات الأصلية',
	'fast_delivery'=>'خدمة التوصيل السريع',
	'fast_delivery_desc'=>'توصيل سريع وأسعار منافسة وخدمات ممتازة',
	
	'HeaderOffer' => 'احصل على خصم حتى 40% على طلبك الأول! تسوق الآن',
	'Welcome'=>'مرحبا',
	'Guest Checkout'=>"تابع كزائر",
	...
	"Shop"=>"تسوق",
	"30%OFF"=>"احصل على خصم حتى 30% على طلبك الأول! تسوق الآن",
	"TOP SELLING OF THE WEEK"=>"الأفضل مبيعاً هذا الأسبوع",
	"View All"=>"عرض الكل",
	"NEWEST PRODUCTS"=>"احدث المنتجات",
	"FOLLOW US"=>"تابعنا",
	"INFORMATION"=>"معلومات",
	"OUR SERVICES"=>"خدماتنا",
	"ABOUT STORE"=>"عن الشركة",
	"dubai_address" => "مدينة دبي الطبية، شارع ابن سينا، الإمارات العربية المتحدة",
	"About Us" => "About Us",
	"Refund Plicy" => "سياسة الإرجاع",
	"Term & services" => "الشروط والاحكام",
	"NEW CUSTOMER" => "مستخدم جديد",
	"Email Address" => "البريد الإلكتروني",
	"refund_policy_statment." => "إنشائك للحساب يعني موافقتك على الشروط والاحكام وسياسة الخصوصية وسياسة الإرجاع",
	"social_network_statment" => "تسجيل الدخول عن طريق وسائل التواصل الاجتماعي",
	"Facebook" => "فيسبوك",
	"Google" => "جوجل",
	...
	"Discount (Coupon)" => "الخصم (الكوبون)",
	"Price" => "السعر",
	"Items" => "المنتجات",
	"Apply" => "استخدام",
	"Update Cart" => "تحديث عربة التسوق",
	"Back To Shopping" => "تكملة التسوق",
	"Coupon Code" => "رمز الكوبون",
	"Proceed to Checkout" => "تابع للدفع",
	"Logout" => "تسجيل الخروج",
	...
	"Tax" => "الضريبة",
	"Shipping Cost" => "قيمة الشحن",
	"Country" => "البلد",
	"State" => "المدينة",
	"Zip/Postal Code" => "عنوان البريد",
	"Company" => "الشركة",
	"Phone Number" => "رقم التواصل",
	"Shipping Price" => "قيمة الشحن",
	"Flat Rate" => "المعدل",
	"Continue" => "إكمال",
	"prefered_pay_method" => "الرجاء اختيار طريقة الدفع",
	"notes_of_order" => "الرجاء كتابة الملاحظات هنا",
	"ORDER NOTES & SUMMARY" => "ملخص الطلب والملاحظات",
	"Order Now" => "اطلب الآن",
	"Braintree" => "Braintree",
	"Stripe" => "الشريط",
	"Cash on Delivery" => "نقداً عند التوصيل",
	"Paypal" => "باي بال",
	"Instamojo" => "انستا موجو",
	"Hyperpay" => "هايبر باي",
	"Congrates" => "مبروك",
	"success_product" => "تم إضافة المنتج بنجاح، شكراً! تكملة التسوق",
	"OK" => "حسناً",
	"same_billing_address" => "نفس العنوان للشحن والفواتير",
