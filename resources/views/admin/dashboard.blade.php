...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                      <h3>{{ $result['lowOfStock'] }}</h3>
        			  <p>{{ trans('labels.total_low_stock') }}</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                    </div>
                    <a href="{{ URL::to('admin/lowinstock')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.total_low_stock_link') }}">{{ trans('labels.total_low_stock_link') }} <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                      <h3>{{ $result['currency'][19]->value }}{{ $result['total_money_earned'] }}</h3>
                ...
                <div class="col-sm-12">
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                           ...
                           <li>
                               <select name="source" class="form-control" id="source_add_sale" style="margin: 10px 0px;">
                                   <option value="">-- Source --</option>
                                   <option {{ (Request::has('source') and Request::get('source') == '1') ? 'selected' : '' }} value="1">Website</option>
                                   <option {{ (Request::has('source') and Request::get('source') == '2') ? 'selected' : '' }} value="2">Application</option>
                               </select>
                            </li>
                        </ul>
            ...
            @endif
            <!-- /.row -->
            @if (count($result['statistics']['top_browsers']))
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                        ...
                        <div class="box-body no-padding">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                @foreach($result['statistics']['top_browsers'] as $browser)
                                    <tr>
            ...
            @endif
            @if (count($result['statistics']['most_visited_pages']))
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                            ...
                            <div class="box-body no-padding">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    @foreach($result['statistics']['most_visited_pages'] as $page)
                                        <tr>
                                            <td>{{ $page['url'] }}</td>
            ...
            @endif
            @if (count($result['statistics']['top_referrers']))
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                            ...
                            <div class="box-body no-padding">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    @foreach($result['statistics']['top_referrers'] as $referrer)
                                        <tr>
                                            <td>{{ $referrer['url'] }}</td>
