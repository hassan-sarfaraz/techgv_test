  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row">
        ...
        <div class="col-xs-7">
          ...
          @if(isset($data['orders_data'][0]->pickup_store_id) and !empty($data['orders_data'][0]->pickup_store_id))
            <p class="lead" style="margin-bottom:10px">{{ trans('labels.store') }}:</p>
            <p class="text-muted well well-sm no-shadow" style="text-transform:capitalize">
              @php
                $pickup_id = $data['orders_data'][0]->pickup_store_id;
