                        ...
                        <div class="col-lg-12 form-inline">
                            <form method="get" action="">
                                <div class="input-group-form search-panel">
                                    <input type="text" class="form-control input-group-form" name="customers_name" placeholder="Search Customer Name" value="{{ Request::get('customers_name') }}" />
                                    <input type="date" class="form-control input-group-form" name="date_purchased" value="{{ Request::get('date_purchased') }}" />
