<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <?php }
      if ($check->store_view == 1) {
      ?>
        <li class="treeview {{ Request::is('admin/stores/display') ? 'active' : '' }} {{ Request::is('admin/stores/add') ? 'active' : '' }} {{ Request::is('admin/stores/edit/*') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/stores/display')}}">
            <i class="fa fa-industry" aria-hidden="true"></i> <span>{{ trans('labels.stores') }}</span>
          </a>
        </li>
      ...
      ?>
        <li class="treeview {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/display') ? 'active' : '' }}  {{ Request::is('admin/products/attributes/add') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} {{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }} {{ Request::is('admin/products/inventory/display') ? 'active' : '' }} {{ Request::is('admin/products/inventory/display/bulk') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/products/inventory/display/bulk') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/inventory/display/bulk')}}"><i class="fa fa-circle-o"></i> Inventory Bulk</a></li>
            <li class="{{ Request::is('admin/products/promotion/promotion_list') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/promotion/promotion_list')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.promotion_list') }}</a></li>
            @endif
          </ul>
        </li>
      <?php } ?>
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/orders/unpaidOrder') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/orders/unpaidOrder')}}"><i class="fa fa-list-ul" aria-hidden="true"></i> <span> {{ trans('labels.link_unpaidorders') }}</span>
          </a>
        </li>
      <?php } ?>
      <?php
      ...
      ?>
        <li class="treeview {{ Request::is('admin/statscustomers') ? 'active' : '' }} {{ Request::is('admin/outofstock') ? 'active' : '' }} {{ Request::is('admin/statsproductspurchased') ? 'active' : '' }} {{ Request::is('admin/statsproductsliked') ? 'active' : '' }} {{ Request::is('admin/lowinstock') ? 'active' : '' }} {{ Request::is('admin/conversion-rate') ? 'active' : '' }} {{ Request::is('admin/top-searched-keywords') ? 'active' : '' }} {{ Request::is('admin/best-performing-categories') ? 'active' : '' }} {{ Request::is('admin/best-selling-products') ? 'active' : '' }}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/conversion-rate') ? 'active' : '' }}"><a href="{{ URL::to('admin/conversion-rate')}}"><i class="fa fa-circle-o"></i> Conversion Rate Report</a></li>
            <li class="{{ Request::is('admin/top-searched-keywords') ? 'active' : '' }}"><a href="{{ URL::to('admin/top-searched-keywords')}}"><i class="fa fa-circle-o"></i> Top 50 Google Search terms</a></li>
            <li class="{{ Request::is('admin/best-performing-categories') ? 'active' : '' }}"><a href="{{ URL::to('admin/best-performing-categories')}}"><i class="fa fa-circle-o"></i> Best Performing Categories</a></li>
            <li class="{{ Request::is('admin/best-selling-products') ? 'active' : '' }}"><a href="{{ URL::to('admin/best-selling-products')}}"><i class="fa fa-circle-o"></i> Best Selling Products</a></li>
          </ul>
        </li>
      <?php } ?>
      <?php
