                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('labels.OptionName') }}</th>
                                            <th>{{ trans('labels.OptionValue') }}</th>
                                            <th style="width: 100px;">{{ trans('labels.PricePrefix') }}</th>
                                            <th>{{ trans('labels.Price') }} (Excl. Tax)</th>
                                            <th>{{ trans('labels.Price') }} (Incl. Tax)</th>
                                            <th>{{ trans('labels.Action') }}</th>
                                                ...
                                                @if($products_attributes->is_default == '0')
                                                    @php
                                                        ...
                                                        if($products_attributes->price_prefix == '-') {
                                                            $newprice = ($result['data']['products_price'] - $products_attributes->options_values_price);
                                                        }else if($products_attributes->price_prefix == '+') {
                                                            $newprice = ($result['data']['products_price'] + $products_attributes->options_values_price);
                                                        }
                                                    @endphp
                                                    <tr>
                                                        ...
                                                        <td>{{ $products_attributes->options_name }}</td>
                                                        <td>{{ $products_attributes->options_values_name }}</td>
                                                        <td class="text-center">{{ $products_attributes->price_prefix }}</td>
                                                        <td>{{ $newprice }}</td>
                                                        <td>{{ pd_adjust_price_with_tax($newprice) }}</td>
                                                        <td>
                                  ...
                                  {{ trans('labels.OptionValuesText') }}</span>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="col-xs-12 col-sm-2 col-md-4 control-label">{{ trans('labels.Price') }} (Excl. Tax)</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="col-xs-12 col-sm-2 col-md-4 control-label">{{ trans('labels.Price') }} (Incl. Tax)</label>
                                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                                            {!! Form::text('options_values_price_temp',  '0', array('class'=>'form-control', 'id'=>'options_values_price_temp')) !!}
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.NumericValueError') }}</span>
                                                        </div>
