                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ProductsPrice') }} (Excl. Tax)<span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_price', 0, array('class'=>'form-control number-validate', 'id'=>'products_price')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ProductsPrice') }} (Incl. Tax)</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_price_temp', 0, array('class'=>'form-control number-validate', 'id'=>'products_price_temp')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            {{ trans('labels.ProductPriceText') }}
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text('products_weight', 0, array('class'=>'form-control number-validate', 'id'=>'products_weight')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane @if($key==0) active @endif" id="product_<?=$languages->languages_id?>">
                                                            <div class="">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Details') }}<span style="color:red;">*</span> ({{ $languages->name }})</label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <textarea id="editor_new<?=$languages->languages_id?>" name="products_details_<?=$languages->languages_id?>" class="form-control" rows="5"></textarea>
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                            {{ trans('labels.EnterProductDetailIn2') }} {{ $languages->name }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        CKEDITOR.replace('editor_new{{$languages->languages_id}}');
        @endforeach
