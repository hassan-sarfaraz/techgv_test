...
<div class="form-group">
    <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.products_attributes_to') }}</label>
    <div class="col-sm-10 col-md-8">
        ...
        @else
            @foreach ($result['attributes'] as $attribute)
                ...
                @endforeach
            <input type="hidden" name="offer_type_to" value="variable_product">
        @endif
...
<div class="form-group">
    <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.products_attributes_to') }}</label>
    <input type="hidden" name="offer_type_to" value="single_product">
    <input type='hidden' id='has-attribute' value='1'>
    <input type='hidden' id='has-attribute' value='0'>
