                      ...
                      <div id="p2" class="owl-carousel" style="margin-bottom: 10px;">
                        ...
                        <div class="product">
                            <article>
                              ...
                              <div class="price">
                                @if(!empty($products->discount_price))
                                @if($products->currency_symbol_left != null){{$products->currency_symbol_left}}@endif
                                  <span class="price_value">{{pd_format_number($products->discount_price+0)}}</span>@if($products->currency_symbol_right != null){{$products->currency_symbol_right}}@endif
                                <span> @if($products->currency_symbol_left != null){{$products->currency_symbol_left}}@endif
                                  <span class="price_value">{{pd_format_number($products->price+0)}}</span>@if($products->currency_symbol_right != null){{$products->currency_symbol_right}}@endif</span>
                                @else
                                @if($products->currency_symbol_left != null){{$products->currency_symbol_left}}@endif
                                <span class="price_value">{{pd_format_number($products->price+0)}}</span>@if($products->currency_symbol_right != null){{$products->currency_symbol_right}}@endif
                                @endif
                              </div>
