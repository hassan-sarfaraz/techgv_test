...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'admin' => \App\Http\Middleware\RedirectIfNotAdmin::class,
            ...
            'view_store' => \App\Http\Middleware\store\view_store::class,
            'edit_store' => \App\Http\Middleware\store\edit_store::class,
            'delete_store' => \App\Http\Middleware\store\delete_store::class,
            'add_store' => \App\Http\Middleware\store\add_store::class,
